...
<html> 
	<head>
		...
		<title>ColorMatch game (nehezített)</title>
	</head>
	...
	<!--------------------------topbar--------------------------------->
		<div id="canvas" style="background-color: black;">
			...
			<div id="kezdokep" class="text-center text-light">
				...
				<p>A színek angolul vannak. <strong>Ez a nehezített verzió, ugyanis a szöveg és a szín folyamatosan változik!</strong></p>
